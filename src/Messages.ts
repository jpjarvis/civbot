...
civbot civs [COMMAND]
    ...
    public static get BadlyFormed(): string {
        return "Command is badly formed - see `civbot help` for guidance";
    }

    public static get NotInVoice(): string {
        return "You're not in voice, so I'll set `novoice` on for this draft.";
    }

    public static get AddedCustomCivs(): string {
        return "Custom civs added. Add the `custom` flag to your draft to use them.";
    }

    public static get ClearedCustomCivs(): string {
        return "All custom civs deleted.";
    }

    public static get NoCustomCivs(): string {
        return "You don't have any custom civs. You can add them with `civbot civs add`.";
    }
